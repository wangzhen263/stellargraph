...
class W2V_Sampled:
    ...
    def eval_classification(self, session, labels, existing_vocab, train_size=0.5, use_ml_splitter=False):
        sk_graph = self._skipgram_graph
        ...
        if len(labels.shape) > 1 and labels.shape[1] > 1:
            ...
            shuffle = model_selection.ShuffleSplit(
                n_splits=5, train_size=train_size, test_size=1-train_size)
